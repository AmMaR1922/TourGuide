...
namespace InfrastructureLayer.Migrations
{
    ...
    [Migration("20250705170757_ConvertDurationFromStringIntoInt")]
    partial class ConvertDurationFromStringIntoInt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainLayer.Entities.ActivityTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Entities.CategoryTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Entities.IncludesTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("IncludesTranslations");
                });
            ...
            modelBuilder.Entity("DomainLayer.Entities.TripTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DomainLayer.Entities.ActivityTranslation", b =>
                {
                    b.HasOne("DomainLayer.Entities.Activity", "Activity")
                        .WithMany("ActivityTranslations")
                        .HasForeignKey("ActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DomainLayer.Entities.Language", "Language")
                        .WithMany("ActivityTranslation")
            ...
            modelBuilder.Entity("DomainLayer.Entities.Activity", b =>
                {
                    b.Navigation("ActivityTranslations");
            ...
            modelBuilder.Entity("DomainLayer.Entities.Includes", b =>
                {
                    b.Navigation("IncludesTranslations");
            ...
            modelBuilder.Entity("DomainLayer.Entities.Language", b =>
                {
                    b.Navigation("ActivityTranslation");
